...
if __name__ == '__main__':
    ...
    calculate_correlation('RG65', 'glove', 'wikipedia', 50)
    calculate_correlation('RG65', 'glove', 'wikipedia', 300)
    calculate_correlation('RG65', 'glove', 'twitter', 50)
    calculate_correlation('RG65', 'glove', 'twitter', 200)
    calculate_correlation('RG65', 'fasttext', 'wikipedia', 300)
    calculate_correlation('RG65', 'fasttext', 'crawl', 300)
    calculate_correlation('RG65', 'lexvec', 'wikipedia', 300)
    calculate_correlation('RG65', 'lexvec', 'crawl', 300)
    calculate_correlation('RG65', 'word2vec', 'googlenews', 300)
    calculate_correlation('RG65', 'numberbatch', 'conceptnet', 300)

    calculate_correlation('RW2034', 'glove', 'wikipedia', 50)
    calculate_correlation('RW2034', 'glove', 'wikipedia', 300)
    calculate_correlation('RW2034', 'glove', 'twitter', 50)
    calculate_correlation('RW2034', 'glove', 'twitter', 200)
    calculate_correlation('RW2034', 'fasttext', 'wikipedia', 300)
    calculate_correlation('RW2034', 'fasttext', 'crawl', 300)
    calculate_correlation('RW2034', 'lexvec', 'wikipedia', 300)
    calculate_correlation('RW2034', 'lexvec', 'crawl', 300)
    calculate_correlation('RW2034', 'word2vec', 'googlenews', 300)
    calculate_correlation('RW2034', 'numberbatch', 'conceptnet', 300)

    calculate_correlation('Verb143', 'glove', 'wikipedia', 50)
    calculate_correlation('Verb143', 'glove', 'wikipedia', 300)
    calculate_correlation('Verb143', 'glove', 'twitter', 50)
    calculate_correlation('Verb143', 'glove', 'twitter', 200)
    calculate_correlation('Verb143', 'fasttext', 'wikipedia', 300)
    calculate_correlation('Verb143', 'fasttext', 'crawl', 300)
    calculate_correlation('Verb143', 'lexvec', 'wikipedia', 300)
    calculate_correlation('Verb143', 'lexvec', 'crawl', 300)
    calculate_correlation('Verb143', 'word2vec', 'googlenews', 300)
    calculate_correlation('Verb143', 'numberbatch', 'conceptnet', 300)
