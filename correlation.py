...
if __name__ == '__main__':
    ...
    calculate_correlation('WordSim353', 'word2vec', 'freebase', 1000)
    calculate_correlation('WordSim353', 'word2vec', 'google_news', 300)
    ...
    calculate_correlation('SimLex999', 'word2vec', 'freebase', 1000)
    calculate_correlation('SimLex999', 'word2vec', 'google_news', 300)
    ...
    calculate_correlation('SimVerb3500', 'word2vec', 'freebase', 1000)
    calculate_correlation('SimVerb3500', 'word2vec', 'google_news', 300)
    ...
    calculate_correlation_pos('SimLex999', 'word2vec', 'freebase', 1000)
    calculate_correlation_pos('SimLex999', 'word2vec', 'google_news', 300)
